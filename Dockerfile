...
add https://github.com/pacman-repo-builder/pacman-repo-builder/releases/download/0.0.0-rc.25/build-pacman-repo-x86_64-unknown-linux-gnu /usr/local/bin/build-pacman-repo
